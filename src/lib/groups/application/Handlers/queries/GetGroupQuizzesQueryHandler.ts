...
export class GetGroupQuizzesQueryHandler
  implements IHandler<GetGroupQuizzesQuery, GetGroupAssignedQuizzesResponseDto>
{
  constructor(private readonly groupRepository: GroupRepository) {}

  async execute(query: GetGroupQuizzesQuery): Promise<GetGroupAssignedQuizzesResponseDto> {
    ...
    if (!isMember) throw new UserNotMemberOfGroupError(currentUserId.value, groupId.value);
