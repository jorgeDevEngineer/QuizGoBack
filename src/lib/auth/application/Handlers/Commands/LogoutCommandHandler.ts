...
export class LogoutCommandHandler implements IHandler<LogoutCommand, Result<void>> {
  constructor(@Inject('ITokenProvider') private readonly tokenProvider: ITokenProvider) {}
